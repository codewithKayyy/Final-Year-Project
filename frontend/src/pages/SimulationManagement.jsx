...
const SimulationManagement = () => {
    ...
    return (
        <div className="space-y-6">
            {/* Breadcrumb if campaign context */}
            {campaign && (
                ...
                <DialogContent className="max-w-lg">
                    ...
                    {selectedSimulation && (
                        <div className="space-y-2 text-sm">
                            ...
                            <p><strong>Scheduled Start:</strong> {selectedSimulation.scheduled_start ? new Date(selectedSimulation.scheduled_start).toLocaleString() : "N/A"}</p>
                            <p><strong>Actual Start:</strong> {selectedSimulation.actual_start ? new Date(selectedSimulation.actual_start).toLocaleString() : "N/A"}</p>
                            <p><strong>Completed At:</strong> {selectedSimulation.completed_at ? new Date(selectedSimulation.completed_at).toLocaleString() : "N/A"}</p>
                            <p><strong>Type:</strong> {selectedSimulation.type || "N/A"}</p>
                            <p><strong>Campaign:</strong> {selectedSimulation.campaign_name || "N/A"}</p>
                            <p><strong>Created By:</strong> {selectedSimulation.created_by || "N/A"}</p>
                        </div>
                    )}
                </DialogContent>
            </Dialog>
